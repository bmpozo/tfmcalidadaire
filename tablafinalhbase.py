...
def insert_row(batch, diccionario):
    batch.put('20160830',{'SO2':diccionario['SO2'],'calidadSO2':diccionario['calidadSO2'],'CO':diccionario['CO'],'calidadCO':diccionario['calidadCO'],'NO2':diccionario['NO2'],'calidadNO2':diccionario['calidadNO2'],
    'PM10':diccionario['PM10'],'calidadPM10':diccionario['calidadPM10'],'O3':diccionario['O3'],'calidadO3':diccionario['calidadO3'],'calidadaire':diccionario['calidadaire'],
    'temp':diccionario['temp'],'tempmax':diccionario['tempmax'],'tempmin':diccionario['tempmin'],'temp_cat':diccionario['temp_cat'],'prob_prec':diccionario['prob_prec'],'prob_prec_cat':diccionario['prob_prec_cat'],
    'viento':diccionario['viento'],'viento_cat':diccionario['viento_cat'],'vel_media':diccionario['vel_media'],'vel_media_cat':diccionario['vel_media_cat'],'calidadfinal':diccionario['calidadfinal']})
try:
    insert_row(batch, diccionario)
    batch.send()
finally:
